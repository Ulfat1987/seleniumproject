...
//       3. Saving image in the path
    ...
    //Change background color of a web element by using JS
    ...
    //Add Border Style of a web element by using JS
    public void addBorderStyleByJS(WebElement element, String borderStyle) {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        //arguments[0].style.border='colorName'
